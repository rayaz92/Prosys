...
public class DeviceList extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.distdevice_list);

		scanButton = (Button) findViewById(R.id.BTNScan11);
		scanButton.setOnClickListener(this);
		setResult(Activity.RESULT_CANCELED);
		// Initialize array adapters. One for already paired devices and
		// one for newly discovered devices
		mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this,
				R.layout.distdevice_name);

		// mNewDevicesArrayAdapter = new ArrayAdapter<String>(this,
		// R.layout.device_name);

		// Find and set up the ListView for paired devices
		pairedListView = (ListView) findViewById(R.id.listpaired_devices1);

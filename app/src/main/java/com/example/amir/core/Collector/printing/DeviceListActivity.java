...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.colldevice_list_inch);   //��ʾ�б����
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.colldevice_name);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.colldevice_name);
